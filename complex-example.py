...
class Print_Shipping_Invoice_2:
    ...
    def _header_footer(canvas, doc):
        ...
        styles.add(ParagraphStyle(name='CustomTitle', fontSize=18, leading=22, alignment=TA_CENTER))
        styles.add(ParagraphStyle(name='CustomHeader', fontSize=18, leading=18, alignment=TA_LEFT))
        styles.add(ParagraphStyle(name='CustomStyle', leading=12))
        ...
        header_data = []
        row1_info1 = Paragraph('Khank Khank Khank Khank Khank Khank Khank Khank Khank Khank Khank Khank Khank Khank Khank Khank Khank Khank Khank Khank Khank Khank Khank Khank Khank Khank Khank Khank', styles['CustomHeader'])
        header_data.append([row1_info1])

        row2_info1 = Paragraph('Lant', styles['LeftAlign'])
        ...
        row3_info1 = Paragraph('Kelvin Smith', styles['LeftAlign'])
        row4_info1 = Paragraph('Labmate', styles['LeftAlign'])
        row5_info1 = "Attention"
        ...
        title_row2 = ['', 'S/O NO.', 'DESCRIPTION', '(' + "OM" + ')', '',
                      '(' + "USD" + ')', '(' + "LSD" + ')']
    ...
    def print_report(self):
        ...
        # buffer = self.buffer
        doc = SimpleDocTemplate("dynamic_invoice.pdf",
                                rightMargin=42,
                                leftMargin=60,
                                topMargin=260,
                                bottomMargin=42,
        ...
        elements.append(Paragraph("In publishing and graphic design, Lorem ipsum is a placeholder text commonly used to demonstrate the visual form of a document or a typeface without relying on meaningful content. Lorem ipsum may be used as a placeholder before final copy is available."))
